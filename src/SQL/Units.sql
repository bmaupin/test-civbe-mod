...
VALUES
  ...
  ('CIVILIZATION_ARC', 'UNITCLASS_CAVALRY', NULL),
  ...
  ('CIVILIZATION_INTEGR', 'UNITCLASS_CAVALRY', NULL),
  ...
  ('CIVILIZATION_CHUNGSU', 'UNITCLASS_CAVALRY', NULL),
  ...
  -- ('CIVILIZATION_FRANCO_IBERIA', 'UNITCLASS_CAVALRY', NULL),
  ('CIVILIZATION_FRANCO_IBERIA', 'UNITCLASS_MARINE', 'UNIT_CAVALRY'),
  ...
  -- ('CIVILIZATION_POLYSTRALIA', 'UNITCLASS_CAVALRY', NULL),
  ('CIVILIZATION_POLYSTRALIA', 'UNITCLASS_MARINE', 'UNIT_CAVALRY'),
  ...
  -- ('CIVILIZATION_RUSSIA', 'UNITCLASS_CAVALRY', NULL),
  ('CIVILIZATION_RUSSIA', 'UNITCLASS_MARINE', 'UNIT_CAVALRY'),
  ...
  ('CIVILIZATION_AFRICAN_UNION', 'UNITCLASS_CAVALRY', NULL),
  ...
  ('CIVILIZATION_BRASILIA', 'UNITCLASS_CAVALRY', NULL),
  ...
  ('CIVILIZATION_PAN_ASIA', 'UNITCLASS_CAVALRY', NULL),
  ...
  ('CIVILIZATION_NORTH_SEA_ALLIANCE', 'UNITCLASS_CAVALRY', NULL),
...
SELECT 'UNITUPGRADE_NANOHIVE_1S', PerkType
...
INSERT INTO UnitUpgradePerkChoices (UpgradeType, PerkType)
SELECT 'UNITUPGRADE_GELIOPOD_1S', PerkType
FROM UnitUpgradePerkChoices
...
INSERT INTO UnitUpgradePerkChoices (UpgradeType, PerkType)
SELECT 'UNITUPGRADE_AQUILON_1H', PerkType
FROM UnitUpgradePerkChoices
WHERE UpgradeType = 'UNITUPGRADE_RANGED_MARINE_1';
